...
<div class="container">
    ...
    <div class="row">
		<div class="col-lg-12">
		<div class="card">
		<div class="card-header  p-3"> <a href="#"><i class="fa fa-plus"></i> {{ __('Add New Prodduct Category') }}</a></div>				
			<div class="card-body">				
                     ...
                     <form name="add_name" id="add_name" enctype="multipart/form-data">  
                          <div class="table-responsive">  
                               <table class="table table-bordered bg-light" id="">  
                                    <tr>  
                                         <td><input type="text" name="name[]" placeholder="Enter Products Name" required class="form-control name_list" /> 
                                         </td>  

                                        

                                         <td><button type="button" name="add" id="add" class="btn btn-success">Add New Product</button></td>  
...
var i=1;  
      $('#add').click(function(){  
           ...
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="name[]" placeholder="Enter Products Name" class="form-control name_list" /></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></td></tr>');  
      });  
	  ...
	  $('#add_name').on('submit', function(event){
        event.preventDefault();
	$.ajax({
				url: SITEURL +"/productCategoryentry",
				type:"POST",
		   ...
		   "bFilter" : true,
		    ...
		    "iDisplayLength" : 10,
		    "ajax":{
		        "url": "<?php route('viewproductcategory') ?>",
		        "datatype": "json",
		        "type": "POST",
